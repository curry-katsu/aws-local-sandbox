...
const routes = [
  ...
  { path: '/rds', component: () => import('../views/RdsView.vue'), meta: navigationItems[5] },
  { path: '/cognito', component: () => import('../views/CognitoView.vue'), meta: navigationItems[6] },
  {
    path: '/eventbridge',
    component: () => import('../views/EventBridgeView.vue'),
    meta: navigationItems[7],
  },
  {
    path: '/stepfunctions',
